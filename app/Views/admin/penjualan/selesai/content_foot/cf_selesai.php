<script>
    $(document).ready(function() {
        ...
        $('#tbl-selesai').DataTable({
            ...
            "ajax": {
                "url": base_url + '/Admin/Selesai/load_selesai',
                "type": "POST",
                dataType: 'json',
                "data": function(data) {
    ...
    function load_selesai() {
        $('#tbl-selesai').DataTable().ajax.reload();
    }

    function lihat_pesanan(id_akun, id_pesanan) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                load_list_pesanan_selesai(id_pesanan);
    ...
    function load_list_pesanan_selesai(id_pesanan) {
        ...
        $('#tbl-list-pesanan').DataTable({
            ...
            "ajax": {
                "url": base_url + '/Admin/Pesanan/load_list_pesanan_selesai',
                "type": "POST",
                "data": function(data) {
                    // data.tgl = $('#filter_tgl').val();
        ...
        cek_total_harga(id_pesanan);
    }

    function cek_total_harga(id_pesanan) {
        $.ajax({
            type: "GET",
            url: base_url + '/Admin/Pesanan/cek_total_harga_selesai/' + id_pesanan,
            beforeSend: function(e) {
                if (e && e.overrideMimeType) {
                    e.overrideMimeType("application/json;charset=UTF-8");
                }
    ...
    function ambil_pesanan(id_akun) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "GET",
                    url: base_url + '/Admin/Selesai/ambil_pesanan/' + id_akun,
                    beforeSend: function(e) {
                        if (e && e.overrideMimeType) {
                            e.overrideMimeType("application/json;charset=UTF-8");
                        }
